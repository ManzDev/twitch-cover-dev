const T=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function a(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerpolicy&&(r.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?r.credentials="include":e.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(e){if(e.ep)return;e.ep=!0;const r=a(e);fetch(e.href,r)}};T();class l extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
    ...
    </div>`}}customElements.define("cover-svg",u);const F=450,H=["#bbba","#aaaa","#999a","#777a","#555a"];class y extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
        --cover-vinyl:
    ...
    `}connectedCallback(){this.render(),this.fillGrid(),this.fillStars()}fillGrid(){const t=this.shadowRoot.querySelector(".grid-container .grid");for(let a=0;a<120;a++){const i=document.createElement("div");t.appendChild(i)}}fillStars(){const t=this.shadowRoot.querySelector(".stars");for(let a=0;a<F;a++){const i=document.createElement("div");i.classList.add("star");const e=Math.floor(Math.random()*H.length),r=H[e],o=Math.floor(Math.random()*400),c=Math.floor(Math.random()*400),s=1+Math.floor(Math.random()*2);i.style.setProperty("--y",`${c}px`),i.style.setProperty("--x",`${o}px`),i.style.setProperty("--color",r),i.style.setProperty("--size",`${s}px`),t.appendChild(i)}}render(){this.shadowRoot.innerHTML=`
    ...
    <div class="container">
    ...
    </div>`}}customElements.define("cover-node-js",M);const L=["#1A5771","#216D8E","#F79F39","#2E9AC8","#39BEF7","#38BDF8","#134053"].reverse(),S=(n,t)=>{const a=n*2+(n-2)*2,i=n-2,e=L[t],r=(7-t)/2,o=t/2,c=`--size: ${i}; --delay: ${o}s; --color: ${e}; --margin: ${r}px`,s="<div></div>".repeat(n+1),R=`<div class="central grid" style="${c}">${t<7?S(i,t+1):""}</div>`,A="<div></div>".repeat(a-(n+2)+1);return s+R+A};class C extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
      ...
      .grid {
        ...
        & > div:not(.central) {
          background: var(--color, ${L[0]});
          /* box-shadow: 0 0 5px 1px
            color-mix(in srgb, var(--color, ${L[0]}), black 30%);*/
    ...
    </div>`}}customElements.define("cover-tailwind",C);const B={html:`
...
`};class E extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
    ...
    `}}customElements.define("cover-box",E);
