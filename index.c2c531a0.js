const R=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const i of e)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function r(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerpolicy&&(i.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?i.credentials="include":e.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(e){if(e.ep)return;e.ep=!0;const i=r(e);fetch(e.href,i)}};R();class l extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
    ...
    </div>`}}customElements.define("cover-html",l);class d extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
    ...
    <div class="container">
    </div>`}}customElements.define("retro-square",p);class h extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
    ...
    </div>`}}customElements.define("cover-postcss",h);class v extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
    ...
    </div>`}}customElements.define("cover-terminal",f);class g extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
        --bgcolor: #151515;
    ...
    </div>`}}customElements.define("cover-vue",g);class m extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
        --cover-vinyl:
    ...
    </div>`}}customElements.define("cover-webcomponents",m);class x extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
        --bgcolor: #201d30;
    ...
    </div>`}}customElements.define("cover-fundamentos",x);class b extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
        --bgcolor: #000;
    ...
    </div>`}}customElements.define("cover-svg",b);const A=450,E=["#bbba","#aaaa","#999a","#777a","#555a"];class u extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
        --cover-vinyl:
    ...
    `}connectedCallback(){this.render(),this.fillGrid(),this.fillStars()}fillGrid(){const t=this.shadowRoot.querySelector(".grid-container .grid");for(let r=0;r<120;r++){const a=document.createElement("div");t.appendChild(a)}}fillStars(){const t=this.shadowRoot.querySelector(".stars");for(let r=0;r<A;r++){const a=document.createElement("div");a.classList.add("star");const e=Math.floor(Math.random()*E.length),i=E[e],o=Math.floor(Math.random()*400),n=Math.floor(Math.random()*400),s=1+Math.floor(Math.random()*2);a.style.setProperty("--y",`${n}px`),a.style.setProperty("--x",`${o}px`),a.style.setProperty("--color",i),a.style.setProperty("--size",`${s}px`),t.appendChild(a)}}render(){this.shadowRoot.innerHTML=`
    ...
    <div class="container">
      ...
      <div class="stars"></div>
    </div>`}}customElements.define("cover-npm",u);class y extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
        --cover-vinyl:
    ...
    </div>`}}customElements.define("cover-typescript",y);class w extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
        --cover-vinyl:
    ...
    </div>`}}customElements.define("cover-react",w);class z extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
        --bgcolor: #081014;
    ...
    </div>`}}customElements.define("cover-astro",z);class k extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
        --bgcolor: #131418;
    ...
    <div class="container">
    ...
    </div>`}}customElements.define("cover-node-js",k);const M=["#1A5771","#216D8E","#F79F39","#2E9AC8","#39BEF7","#38BDF8","#134053"].reverse(),H=(c,t)=>{const r=c*2+(c-2)*2,a=c-2,e=M[t],i=(7-t)/2,o=t/2,n="<div></div>".repeat(c+1),s=`<div class="central grid" style="--size: ${a}; --delay: ${o}s; --color: ${e}; --margin: ${i}px">${t<7?H(a,t+1):""}</div>`,S="<div></div>".repeat(r-(c+2)+1);return n+s+S};class L extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
      ...
      .grid {
        ...
        & > div:not(.central) {
          background: var(--color, ${M[0]});
          /* box-shadow: 0 0 5px 1px
            color-mix(in srgb, var(--color, ${M[0]}), black 30%);*/
    ...
    </div>`}}customElements.define("cover-tailwind",L);const T={html:`
...
`};class C extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
    ...
    `}connectedCallback(){this.logo=this.getAttribute("logo"),this.render();const t=this.shadowRoot.querySelector(".container"),r=document.createElement(`cover-${this.logo}`);r.classList.add("box"),t.insertAdjacentElement("afterbegin",r)}render(){this.shadowRoot.innerHTML=`
    <style>${C.styles}</style>

    <div class="container">
      ${T[this.logo]}
    </div>
    `}}customElements.define("cover-box",C);
