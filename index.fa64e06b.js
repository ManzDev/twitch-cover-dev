const L=function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const r of t.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function a(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerpolicy&&(t.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?t.credentials="include":e.crossorigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function i(e){if(e.ep)return;e.ep=!0;const t=a(e);fetch(e.href,t)}};L();class c extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
    ...
    </div>`}}customElements.define("cover-html",c);class n extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
    ...
    </div>`}}customElements.define("cover-css",n);class s extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --size: 200px;
    ...
    <div class="container">
    </div>`}}customElements.define("retro-square",s);class l extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
    ...
    </div>`}}customElements.define("cover-postcss",l);class d extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
    ...
    </div>`}}customElements.define("cover-js",d);class h extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
    ...
    </div>`}}customElements.define("cover-terminal",h);class p extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
        --bgcolor: #151515;
    ...
    </div>`}}customElements.define("cover-vue",p);class v extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
        --cover-vinyl:
    ...
    </div>`}}customElements.define("cover-webcomponents",v);class f extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
        --bgcolor: #201d30;
    ...
    </div>`}}customElements.define("cover-fundamentos",f);class g extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
        --bgcolor: #000;
    ...
    </div>`}}customElements.define("cover-svg",g);const C=450,z=["#bbba","#aaaa","#999a","#777a","#555a"];class m extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
        --cover-vinyl:
    ...
    `}connectedCallback(){this.render(),this.fillGrid(),this.fillStars()}fillGrid(){const o=this.shadowRoot.querySelector(".grid-container .grid");for(let a=0;a<120;a++){const i=document.createElement("div");o.appendChild(i)}}fillStars(){const o=this.shadowRoot.querySelector(".stars");for(let a=0;a<C;a++){const i=document.createElement("div");i.classList.add("star");const e=Math.floor(Math.random()*z.length),t=z[e],r=Math.floor(Math.random()*400),k=Math.floor(Math.random()*400),M=1+Math.floor(Math.random()*2);i.style.setProperty("--y",`${k}px`),i.style.setProperty("--x",`${r}px`),i.style.setProperty("--color",t),i.style.setProperty("--size",`${M}px`),o.appendChild(i)}}render(){this.shadowRoot.innerHTML=`
    ...
    <div class="container">
      ...
      <div class="stars"></div>
    </div>`}}customElements.define("cover-npm",m);class x extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
        --cover-vinyl:
    ...
    </div>`}}customElements.define("cover-typescript",x);class b extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
        --cover-vinyl:
    ...
    </div>`}}customElements.define("cover-react",b);class u extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
        --bgcolor: #081014;
    ...
    </div>`}}customElements.define("cover-astro",u);class y extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --width: var(--cover-size);
        --height: var(--cover-size);
        --bgcolor: #131418;
    ...
    </div>`}}customElements.define("cover-node-js",y);const H={html:`
...
`};class w extends HTMLElement{constructor(){super();this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        --cover-size: 400px;
      }
    ...
    `}connectedCallback(){this.logo=this.getAttribute("logo"),this.render();const o=this.shadowRoot.querySelector(".container"),a=document.createElement(`cover-${this.logo}`);a.classList.add("box"),o.insertAdjacentElement("afterbegin",a)}render(){this.shadowRoot.innerHTML=`
    <style>${w.styles}</style>

    <div class="container">
      ${H[this.logo]}
    </div>
    `}}customElements.define("cover-box",w);
